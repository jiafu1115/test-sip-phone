...
package com.googlecode.test.sip.phone.media.rtp;

import org.apache.log4j.Logger;

// RFC 3550
public final class RtpParserUtil {

    private final static Logger logger=Logger.getLogger(RtpParserUtil.class);
    
    private RtpParserUtil(){
    	//no instance
    }
